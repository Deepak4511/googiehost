        ...
        <div class="row sale-row text-center mb-4 cursor-pointer" onclick="window.location.href='https://googiehost.com/blog/go/youstable-dedicated/'">
            ...
            <div class="col-md-3 p-2 d-flex align-items-center justify-content-center">
                <div>
                    ...
                    <p class="mb-0 disc-coupon">(Get Additional 5% Discount
        ...
        <div class="row sale-row text-center mb-4"  onclick="window.location.href='https://googiehost.com/blog/go/interserver-dedicated/'">
            ...
            <div class="col-md-3 p-2 d-flex align-items-center justify-content-center">
                <div>
                    ...
                    <p class="mb-0 disc-coupon">Save 50% on Servers</p>
                </div>
            </div>
        </div>
        ...
        <div class="row sale-row text-center mb-4"  onclick="window.location.href='https://googiehost.com/blog/go/ultahostdedicated/'">
            ...
            <div class="col-md-3 p-2 d-flex align-items-center justify-content-center">
                <div>
                    ...
                    <p class="mb-0 disc-coupon">(Get Additional 7% Discount
        ...
        <div class="row sale-row text-center mb-4" onclick="window.location.href='https://googiehost.com/blog/go/liquidwebdedicated/'">
            ...
            <div class="col-md-3 p-2 d-flex align-items-center justify-content-center">
                <div>
                    ...
                    <p class="mb-0 disc-coupon">Auto Applied with our Affiliate url</p>
                </div>
            </div>
        </div>
        ...
        <div class="custom-review-card">
            ...
            <div class="p-4">
                <div class="row mt-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="mt-3 stats-box">
                            ...
                            <div class="d-flex justify-content-between mt-2"><span>Support </span><strong>4.9/5</strong></div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="mt-3">
                    ...
                    <p class="">YouStable, one of the most Reliable & Cheap Dedicated Server Hosting providers, offers a wide range of web hosting solutions to Enterprises or Big Corporations requiring dedicated web resources like CPU/ Storage/ Network Connectivity/ Highest Uplink to run their websites online 24/7.</p>
                    <p>It allows Full Root access to your dedicated server to enable the user to configure the server as required.Moreover, YouStable offers multiple data servers spread all across the globe, letting you choose the one nearest to your targeted audience, thereby ensuring the lowest latency to the visitors surfing your websites.At times, when users face issues of any sort, YouStable offers Consistent & Dedicated 24/7 Expert Support services to resolve technical doubts as well.</p>
                </div>
                            ...
                            <div id="collapseFeature1" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="hosting-key-features">
                                        <div><i class="fa-solid fa-check feature-check-symbol"></i>Full Root Access to your Server</div>
                                        <div><i class="fa-solid fa-check feature-check-symbol"></i>1Gbps-10Gbps Uplink, 10TB Bandwidth</div>
                                        <div><i class="fa-solid fa-check feature-check-symbol"></i>DDR4 RAM & NVMe SSD Storage)</div>
                                        <div><i class="fa-solid fa-check feature-check-symbol"></i>Multiple OS (Windows/ Linux)</div>
                                        <div><i class="fa-solid fa-check feature-check-symbol"></i>Multiple Data Centers</div>
                                        <div><i class="fa-solid fa-check feature-check-symbol"></i>Free 24/7 Server Monitoring Add-on.</div>
                                        <div><i class="fa-solid fa-check feature-check-symbol"></i>DDoS Protectected, BitNinja Security & Imunify360</div>
                                        <div><i class="fa-solid fa-check feature-check-symbol"></i>24/7 Support.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<section>
    <div>
        ...
        <div class="container p-md-5 tech-specification">
            <h2 class="text-center sec-heading">Technical Specifications to keep in mind while choosing The Best Dedicated Server Hosting</h2>
