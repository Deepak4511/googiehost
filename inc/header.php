...
<body>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown" onmouseover="showDropdown(this)" onmouseout="hideDropdown(this)">
                            <a class="nav-link  text-white" href="#" id="reviewsDropdown" role="button"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Reviews <i class="fa-solid fa-angle-down"></i>
                            </a>
                        ...
                        <li class="nav-item dropdown" onmouseover="showDropdown(this)" onmouseout="hideDropdown(this)">
                            <a class="nav-link SignInUp" href="#" id="loginDropdown">Login</a>
                            <div class="dropdown-menu rounded mb-0   " aria-labelledby="loginDropdown"
                                ...
                                <a class="dropdown-item text-white"
                                    ...
                                    Login</a>
                                <a class="dropdown-item text-white mb-0" href="https://googiehost.com/signup.html">Create
                                    Account</a>
                            </div>
                        </li>
    ...
    <script>
        function showDropdown(element) {
            element.querySelector('.dropdown-menu').style.display = 'block';
        }

        function hideDropdown(element) {
            element.querySelector('.dropdown-menu').style.display = 'none';
        }
    </script>
</body>
